...
UninstallDisplayIcon={app}\PulseBoost.exe
Compression=lzma2
...
[Files]
Source: "build\Release\PulseBoost.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\PulseBoost AI"; Filename: "{app}\PulseBoost.exe"
Name: "{group}\{cm:UninstallProgram,PulseBoost AI}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\PulseBoost AI"; Filename: "{app}\PulseBoost.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\PulseBoost.exe"; Description: "{cm:LaunchProgram,PulseBoost AI}"; Flags: nowait postinstall skipifsilent
